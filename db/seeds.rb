...
upper_body_a_day = Day.find_by(description: "upper_body_a")
workout_ids = [w1.id, w7.id, w14.id, w5.id, w15.id]  
workout_ids.each do |workout_id|
  WorkoutDay.create(workout_id: workout_id, day_id: upper_body_a_day)
end

upper_body_b_day = Day.find_by(description: "upper_body_b")
workout_ids = [w11.id, w13.id, w16.id, w18.id, w26.id]
workout_ids.each do |workout_id|
    WorkoutDay.create(workout_id: workout_id, day_id: upper_body_b_day)
  end

lower_body_a_day = Day.find_by(description: "lower_body_a")
workout_ids = [w34.id, w35.id, w37.id, w36.id, w39.id]
workout_ids.each do |workout_id|
    WorkoutDay.create(workout_id: workout_id, day_id: lower_body_a_day)
end

lower_body_b_day = Day.find_by(description: "lower_body_b")
workout_ids = [w38.id, w35.id, w36.id, w39]
workout_ids.each do |workout_id|
    WorkoutDay.create(workout_id: workout_id, day_id: lower_body_b_day)
end

full_body_day = Day.find_by(description: "full_body")
workout_ids = [w35.id, w37.id, w13.id, w20.id, w29.id, w33.id]
workout_ids.each do |workout_id|
    WorkoutDay.create(workout_id: workout_id, day_id: full_body_day)
end

# days = Day.all

# WorkoutDay.create(workout: w1, day: days[0])
# WorkoutDay.create(workout: w2, day: days[0])
# WorkoutDay.create(workout: w3, day: days[0])

# WorkoutDay.create(workout: w1, day: days[1])
# WorkoutDay.create(workout: w4, day: days[1])
# WorkoutDay.create(workout: w5, day: days[1])
